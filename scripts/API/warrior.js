...
builds["#bersCPS2Banners"] = {
    ...
    specializations: [
        ...
        { name: "Tactics", traits: ["Empowered", "Burning Arrows", "Phalanx Strength"] },
    ...
    armor: {
        ...
        shoulders: { stat: "Viper", rune: "Superior Rune of the Aristocracy" },
        coat: { stat: "Viper", rune: "Superior Rune of the Aristocracy" },
        gloves: { stat: "Viper", rune: "Superior Rune of the Aristocracy" },
        leggings: { stat: "Viper", rune: "Superior Rune of the Aristocracy" },
        boots: { stat: "Viper", rune: "Superior Rune of the Aristocracy" }
    },
    trinket: {
        amulet: "Viper",
        ring1: "Viper",
    ...
    weapons: {
        mainHand1: { type: "Longbow", stat: "Viper", sigils: ["Superior Sigil of Geomancy", "Superior Sigil of Malice"] },
        mainHand2: { type: "Sword", stat: "Viper", sigils: ["Superior Sigil of Geomancy"] },
        offHand1: null,
        offHand2: { type: "Torch", stat: "Viper", sigils: ["Superior Sigil of Malice"] }
    },
    food: ["Fried Golden Dumpling", "Toxic Focusing Crystal"]
};
...
builds["#bersCPSKC"] = {
    ...
    specializations: [
        { name: "Arms", traits: ["Wounding Precision", "Blademaster", "Furious"] },
        { name: "Tactics", traits: ["Empowered", "Empower Allies", "Phalanx Strength"] },
        { name: "Berserker", traits: ["Last Blaze", "Heat the Soul", "King of Fires"] }
    ],
    skils: ["Blood Reckoning", "For Great Justice", "Shattering Blow", "", "Head Butt"],
    armor: {
