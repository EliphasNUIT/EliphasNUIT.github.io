define(["professionBuilds/dataBuilds", "professionBuilds/professionUtilities/professions"], function(
    ...
    var Profession = professions.Revenant;
    var build = null;
    // Condi
    {
        build = new Build("renCondi", Profession);
        ...
        build.specialization.setSpec("spec2", "Devastation", [
            "Ferocious Strikes",
            "Assassin's Presence",
            "Swift Termination"
        ]);
    ...
    // Special
    {
        build = new Build("herVentari", Profession);
        ...
        build.specialization.setSpec("spec1", "Retribution", [
            "Close Quarters",
            "Eye for an Eye",
        ...
        build.specialization.setSpec("spec3", "Herald", [
            "Radiant Revival",
