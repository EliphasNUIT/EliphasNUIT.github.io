define(["professionBuilds/dataBuilds", "professionBuilds/professionUtilities/professions"], function(buildData, professions) {
    ...
    var Elementalist = professions.Elementalist;
    var build = null;
    // Condi
    {

        build = new Build('tempPS',Elementalist);
        ...
        build.wep2 = null;
        build.specialization.setSpec('spec1',"Fire",["Burning Precision", "Pyromancer's Training", "Persisting Flames"]);
        ...
        build = new Build('tempPSSab',Elementalist);
        build.armor.setStats(["Sinister","Sinister","Viper's","Sinister","Sinister","Sinister"]);
        build.armor.setSingleRune("Superior Rune of Balthazar");
        build.consumable.setConsumable("Rare Veggie Pizza",  "Toxic Focusing Crystal");
        build.trinket.setSingleStat("Sinister");
        ...
        build = new Build('weavCondi',Elementalist);
        ...
        build = new Build('weavCondiSab',Elementalist);
        build.armor.setStats(["Viper's","Grieving","Grieving","Grieving","Viper's","Grieving"]);
        build.armor.setSingleRune("Superior Rune of the Renegade");
        build.consumable.setConsumable("Rare Veggie Pizza",  "Toxic Focusing Crystal");
        build.trinket.setSingleStat("Viper's");
    ...
    // Power
    {
        build = new Build('weavPower1',Elementalist);
        ...
        build.wep2 = null;
        build.specialization.setSpec('spec1',"Fire",["Burning Precision", "Pyromancer's Training", "Persisting Flames"]);
        build.specialization.setSpec('spec2',"Arcane",["Renewing Stamina", "Elemental Contingency", "Bountiful Power"]);
        ...
        build = new Build('weavPower2',Elementalist);
        build.armor.setSingleStat("Berserker's");
        build.armor.setSingleRune("Superior Rune of the Scholar");
        build.consumable.setConsumable("Bowl of Sweet and Spicy Butternut Squash Soup", "Superior Sharpening Stone");
        build.trinket.setSingleStat("Berserker's");
        ...
        build = new Build('weavPowerKC',Elementalist);
        build.armor.setSingleStat("Berserker's");
        build.armor.setSingleRune("Superior Rune of the Scholar");
        build.consumable.setConsumable("Bowl of Sweet and Spicy Butternut Squash Soup", "Superior Sharpening Stone");
        build.trinket.setSingleStat("Berserker's");
    ...
    // Special
    {
        build = new Build('tempAura',Elementalist);
        ...
        build.specialization.setSpec('spec3',"Tempest",["Latent Stamina", "Invigorating Torrents", "Elemental Bastion"]);
