define([], function() {
  ...
  var Specialization = function(profession) {
  ...
  Specialization.prototype.setSpec = function(specToSet, specName, traitArray) {
      ...
      for (var i = 0; i < 3; i++) {
        ...
        if (this.profession.traits[trait]) {
          if (this[specToSet].name === this.profession.traits[trait].spe) {
            ...
            console.warn(
              "Warning: " + trait + " is not a " + specName + " trait"
            );
          }
        } else if (trait.length > 0) {
          console.warn(
            "Warning: " + trait + " is not a " + this.profession.name + " trait"
          );
        }
      }
  ...
  Specialization.prototype.getDiv = function(mobile) {
